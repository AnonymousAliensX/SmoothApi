...
class SmoothApiClient {
  Future<void> head(Uri url,
          {Map<String, String>? headers, required Function callback}) =>
      _wrapToRequest('HEAD', url, headers, callback);

  Future<void> get(Uri url,
          {Map<String, String>? headers, required Function callback}) =>
  ...
  Future<void> _wrapToRequest(
      String method, Uri url, Map<String, String>? headers, Function callback,
